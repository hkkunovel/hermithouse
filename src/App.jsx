...
const PENTS=mkSuit('Pentacles','#060e06',Gr,[
  ...
  {n:'X',kr:'동전 10',r:'오랜 노력이 안정적이고 풍요로운 결실로 이어집니다. 지금의 행복을 소중히 여기세요.',e:[<circle key="bg" cx="40" cy="52" r="34" fill="rgba(122,216,112,.06)"/>,...[14,40,62,14,62,18,62,36,62].flatMap((x,i)=>[...pN(x,[16,14,16,40,40,64,64,88,88][i],7,Gr),<circle key={`f${i}`} cx={x} cy={[16,14,16,40,40,64,64,88,88][i]} r="2.5" fill={Gr} opacity=".45"/>])]},
...
function analyzeQuestion(q){
  ...
  const love=['사랑','연애','남자친구','여자친구','남친','여친','짝사랑','고백','이별','헤어','결혼','썸','감정','좋아하','사귀','연인','배우자','남편','아내','데이트','설레','마음','호감','재회','이성','관계','만나는','만나고','만남','그 사람','그사람','좋아지','보고싶','보고 싶','고백','플러팅','밀당','잘될','잘 될','오래갈','오래 갈','차였','차이','차일','고백할','프로포즈','우리 사이','우리사이','애인','파트너','연락','답장','카톡','문자','차버','사이','그남자','그여자','그 남자','그 여자','오빠','언니','형','누나','첫사랑','전남친','전여친','전 남친','전 여친','전남자친구','전여자친구',
